/**
 * @file ui底层，定义了创建ui组件的方法
 * @import core/ui.js, core/event.js, extend/parseTpl.js
 * @module ui
 */
...
(function( ui, $, undefined ) {
    ...
    function zeptolize( name ) {
        ...
        $.fn[ key ] = function( opts ) {
            ...
            $.each( this, function( i, el ) {
                ...
                // 从缓存中取，没有则创建一个
                obj = record( el, name ) || new ui[ name ]( el,
        ...
        /*
         * NO CONFLICT
         * var uiPanel = $.fn.panel.noConflict();
         * uiPanel.call(test, 'fnname');
         */
    ...
    /**
     * @method define
     * @grammar ui.define( name, object[, superClass] )
     * @class
     ...
     *
     */
    ui.define = function( name, object, superClass ) {
        ui[ name ] = createClass( name, object, superClass );
        zeptolize( name );
    };

    ui.widget = function( name, object, superClass ) {
        ui[ name ] = createClass( name, object, superClass );
        zeptolize( name );
    };
     ...
     * @method isWidget
     * @grammar ui.isWidget( anything[, klass] ) => Boolean
     * @param {*} anything 需要判断的对象
     * @param {String|Class} klass 字符串或者类。
     * @example
     * var a = new ui.Button();
     *
     * console.log( ui.isWidget( a ) );    // => true
     * console.log( ui.isWidget( a, 'Dropmenu' ) );    // => false
     */
    ui.isWidget = function( obj, klass ) {

        // 处理字符串的case
        klass = typeof klass === 'string' ? ui[ klass ] || blankFn : klass;
        klass = klass || ui.Base;
    ...
    ui.Base = createClass( 'Base', {
        ...
        trigger: function( name ) {
            var evt = typeof name === 'string' ? new ui.Event( name ) : name,
