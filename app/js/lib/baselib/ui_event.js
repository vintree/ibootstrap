...
(function( ui, $ ) {
    ...
    /**
     * Event类，结合ui.event一起使用, 可以使任何对象具有事件行为。包含基本`preventDefault()`, `stopPropagation()`方法。
     ...
     * }
     * ```
     * @grammar new ui.Event( name[, props]) => instance
    ...
    ui.event = {
         ...
         * @param  {String | Event }   evt     事件名或ui.Event对象实例
         * @param  {*} * 任意参数
         * @return {self} 返回自身，方便链式
         * @chainable
         */
