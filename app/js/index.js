...
/***/ function(module, exports, __webpack_require__) {
	...
	var _autoFont = __webpack_require__(159);

	var _autoFont2 = _interopRequireDefault(_autoFont);

	var _addScript = __webpack_require__(161);
	...
	var _head = __webpack_require__(165);

	var _head2 = _interopRequireDefault(_head);

	var _tips = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginUser = (function (_React$Component) {
	    ...
	    function LoginUser() {
	        ...
	        return _possibleConstructorReturn(this, Object.getPrototypeOf(LoginUser).call(this));
	    }
	...
	var UnLoginUser = (function (_React$Component2) {
	    _inherits(UnLoginUser, _React$Component2);

	    function UnLoginUser() {
	        _classCallCheck(this, UnLoginUser);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(UnLoginUser).call(this));
	    }
...
/***/ function(module, exports) {
	...
	var alert = {
	    ...
	    init: function init(val, callback) {
	    ...
	    initIng: function initIng(callback) {
	        var objAlert, objGroup;
	        //初始化对象
	    ...
	    hide: function hide(objAlert, objGroup) {
	        //隐藏效果
	        //移动短开启滚动
	        document.ontouchmove = function () {
	            return true;
	    ...
	    confirm: function confirm(objAlert, objGroup, callback) {
	    ...
	    view: function view(tx, callback) {
	        var html = '';
...
/***/ function(module, exports) {
	...
	*/
	var confirm = {
	    ...
	    hide: function hide(objConfirm, objGroup) {
	        //隐藏效果
	        //移动短开启滚动
	        document.ontouchmove = function () {
	            return true;
	    ...
	    cancel: function cancel(objConfirm, objGroup) {
	        //取消操作
	        objGroup.find('[rol="cancel"]').on('click', (function () {
	            this.hide(objConfirm, objGroup);
	        }).bind(this));
	    },
	    confirm: function confirm(objConfirm, objGroup, callback) {
	        //确定操作
	        objGroup.find('[rol="confirm"]').on('click', (function () {
	            this.hide(objConfirm, objGroup);
	            if (callback) {
